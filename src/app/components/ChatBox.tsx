...
export default function ChatBox({
  ...
  return (
    <>
      ...
      <div className="border-t border-gray-200 p-4 relative z-10 flex items-center">
        <div className="flex gap-2 mr-4">
          <button className="p-2 rounded-lg bg-white shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-primary/20">
