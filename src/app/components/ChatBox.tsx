      ...
      <div className="border-t border-gray-200 p-4 md:p-6 relative z-10 flex items-center">
        <div className="flex gap-3 mr-6">
          <button 
            ...
            className="p-3 md:p-4 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-primary/20 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary/20"
          >
        ...
        <form onSubmit={onSubmit} className="max-w-4xl mx-auto relative">
          <input
            ...
            className="w-full p-5 md:p-6 pr-14 rounded-2xl border-2 border-gray-200 focus:border-primary focus:ring-2 focus:ring-pink-200 outline-none shadow-sm hover:shadow-md transition-all duration-300 text-base md:text-lg"
          />
          <button
            type="submit"
            disabled={isLoading}
